...
namespace F4calc
{
	...
	{
		public static double F4SeriesRectangle(
		...
		public static double F4SeriesSquare(
			int a, int b, int c1, int c2,
			...
			int nLimit, out int n)
		{
			...
			do {
				r0 = r1;
				r1 = F4SeriesRectangle(a, b, c1, c2, z1, z2, ++n, n);
		...
		public static double F4SeriesTriangle(
			int a, int b, int c1, int c2,
			...
			int nLimit, out int n)
		{
			...
			do {
				r0 = r1;
				r1 = F4SeriesTriangle(a, b, c1, c2, z1, z2, ++n);
			} while(Math.Abs(r0 - r1) > eps && n <= nLimit);
			if(n > nLimit
				|| double.IsNaN(r1)
				|| double.IsInfinity(r1)
